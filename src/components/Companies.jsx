        ...
        try {
            ...
            if (editData) {
                const res = await axios.put(
                    `https://safety-training-academy.onrender.com/api/companies/${editData._id}`,
                ...
                const res = await axios.post(
                    "https://safety-training-academy.onrender.com/api/companies",
...
export default function Companies() {
    ...
    useEffect(() => {
        const fetchCompanies = async () => {
            try {
                const token = localStorage.getItem("token");
                const res = await axios.get("https://safety-training-academy.onrender.com/api/companies", {
                    headers: { Authorization: `Bearer ${token}` },
                });
    ...
    const handleToggle = async (id) => {
        try {
            ...
            const res = await axios.patch(
                `https://safety-training-academy.onrender.com/api/companies/${id}/toggle-status`,
                {},
                { headers: { Authorization: `Bearer ${token}` } }
            );
            setCompanies((prev) =>
    ...
    const handleDelete = async (id) => {
        ...
        try {
            const token = localStorage.getItem("token");
            await axios.delete(`https://safety-training-academy.onrender.com/api/companies/${id}`, {
                headers: { Authorization: `Bearer ${token}` },
            });
