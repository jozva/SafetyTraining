...
function CourseScheduleModal({ course, close }) {
    ...
    const fetchSchedules = async () => {
        ...
        try {
            ...
            const res = await axios.get(
                `https://safety-training-academy-tho8.onrender.com/api/schedules/course/${course._id}`
            )
    ...
    const deleteSession = async (id) => {
        ...
        try {
            ...
            await axios.delete(
                `https://safety-training-academy-tho8.onrender.com/api/schedules/session/${id}`
            )
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            try {
                ...
                await axios.post(
                    "https://safety-training-academy-tho8.onrender.com/api/schedules/session",
                    payload
                )
